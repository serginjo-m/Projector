...
//    
//    var stepViewSetting = ViewSettings()
//    
//    //Save Button
...
//        
//        photoTitle.topAnchor.constraint(equalTo: categoryTitle.bottomAnchor, constant:  17).isActive = true
